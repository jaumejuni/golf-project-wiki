...
## Trabajo de carrocería y restauración completa
...
+ Nuevos coilovers.
+ Palieres de Epytec. Es importante destacar aquí que estos palieres son compatibles con cajas de cambios 02Q colocadas en la posición OEM, y el kit de Fabless Manufacturing deja el motor y la caja de cambios en la posición OEM, por lo que todo encaja 😅.
...
Con el kit, y la carrocería del coche restaurada y repintada, Marc y yo nos pusimos manos a la obra para poner el motor. Necesitamos 2 intentos y unos cuantos emails a Fabless para que nos aclararan las instrucciones de montaje.
...
Tras desmontar el subchasis y hacer las modificaciones en las copas, pudimos intentar poner de nuevo el motor. Era enero de 2023, y esta vez sí, el motor encajó como un guante en la posición OEM.
...
+ Ventiladores Spal de 12" de 1221 CFM cada uno. Es decir, más que suficiente para un motor de 6 cilindros (ver tabla en el siguiente [enlace](https://www.audi-sport.net/xf/threads/best-way-to-calculate-the-size-of-intercooler-required.213538/)) y el BWA tiene 4.

Otro problema que se nos presentó fue qué intercooler utilizar. Había 2 opciones en este caso:
...
Esta configuración con la ECU correctamente programada permite obtener del motor cifras de potencia escandalosas (>350cv), pero a cambio también se sacrifica la fiabilidad del motor. Se puede encontrar más información sobre esta configuración en este [vídeo](https://www.youtube.com/watch?v=66lY09AADV4).
...
+ Sensor MAP 3 bar (038 906 051 C)
+ Mejora o actualización de HPFP – [(VIS Motorsport - Kit de actualización HPFP 2.0 TFSI EA113)](https://rtmgperformance.com/products/vis-motorsport-2-0-tfsi-ea113-hpfp-upgrade-kit).